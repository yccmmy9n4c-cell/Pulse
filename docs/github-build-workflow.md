...
4. The push automatically builds `0.0.0.28`; use **Run workflow** only when an explicit rebuild is needed.
5. Open the completed run and download `pulse-linux-beta-0.0.0.28-linux-x64` from **Artifacts**.
6. Every successful push or manual run on `main` creates or updates the `linux-v0.0.0.28` GitHub prerelease with the three updater assets.

## Expected artifact contents

- `pulse-platform_0.0.0.28_amd64.deb`
- `pulse-platform-0.0.0.28-linux-x64.tar.gz`
- `SHA256SUMS`
- `gui-launch.log`
