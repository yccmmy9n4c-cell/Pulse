...
4. Select **Run workflow**, enter `0.0.0.18`, and start the run.
5. Open the completed run and download `pulse-linux-beta-0.0.0.18-linux-x64` from **Artifacts**.

## Expected artifact contents

- `pulse-platform_0.0.0.18_amd64.deb`
- `pulse-platform-0.0.0.18-linux-x64.tar.gz`
- `SHA256SUMS`
- `gui-launch.log`
